...
public class MedianFilter implements Filter {
	...
	@Override
	public void apply() {
		destinationImage.argb = FilterAppController.applyFilter(sourceImage.argb, kernelWidth, kernelHeight, sourceImage.width, sourceImage.height, kernelWidth * kernelHeight / 2);
	}
}